    ...
    polity: {
      ...
      topics: {
        constitution: {
          ...
          questions: [
            "Describe the key features of the Indian Constitution",
            "What are the fundamental rights guaranteed by the Constitution?",
            "Explain the amendment process of the Indian Constitution",
        ...
        politicalSystem: {
          ...
          questions: [
            "Describe the structure and functions of the Indian Parliament",
            "What are the powers and responsibilities of the President of India?",
            "Explain the role of the Supreme Court in Indian democracy",
            "How does the electoral system work in India?",
          ],
        },
        governance: {
          name: "Governance",
